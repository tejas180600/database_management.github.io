...
<table class="table table-success table-striped">
    ...
    if($num>0)
    {
        ...
        echo "<tr><td>". $row['id'] . "</td><td>" . $row['firstname'] ."</td><td>" .  $row['lastname']. "</td><td>" . $row['gender']. "</td><td>" . $row['mob_num'] . "</td><td>" . $row['department'] . "</td><td>" . $row['city'] . "</td><td>" .$row['state']. "</td><td>" . $row['pincode']. "</td></tr>";
