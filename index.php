...
if(isset($_POST['teacher_login'])=='POST')
{
...
else if(isset($_POST['submit'])=='POST'){
  ...
  $check="SELECT `id` FROM `teacher` where `id`='$id'";
...
if(mysqli_num_rows($res)>0)
{
 echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   ...
   $sql="INSERT INTO `teacher` ( `id`, `firstname`, `lastname`, `username`, `password`, `gender`, `mob_num`, `department`, `city`, `state`, `pincode`) VALUES ( '$id', '$firstname', '$lastname', '$username', '$password', '$gender', '$mob_num', '$department', '$city', '$state', '$pincode');";
...
?>
    <div class="loginbox">
        <h1>Login Here</h1>
        <img src="teacher_login.png" class="logo">
        ...
        ?>" method="POST">
            ...
            <a href="form.html">New to the database ?</a>
        </form>
        </div>
