...
<table class="table table-success table-striped">
    ...
    if($num>0)
    {
        ...
        echo "<tr><td>". $row['rollno'] . "</td><td>" . $row['firstname'] ."</td><td>" .  $row['lastname']. "</td><td>" . $row['branch'] . "</td><td>
        <div class='btn-group'>
        <a class='btn btn-info' href='S_edit.php ?rollno=" .$row['rollno']."'>Update </a>
        <a class='btn btn-danger' href='S_delete.php ?rollno=" .$row['rollno']."'>Delete </a>
        </td>
        </tr>";
