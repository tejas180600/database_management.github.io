...
<div class= "form">
    <form class="row g-3 needs-validation"  action="T_edit.php ?id=<?= $id ?>" method="POST">
            ...
            <div class="col-md-6 position-relative">
              ...
              <div class="col-md-4 position-relative">
                <label for="validationTooltip01" class="form-label">Department</label>
                <input type="text" class="form-control" name="department" id="validationTooltip01" value="<?= $data['department']?>" required>
                <div class="valid-tooltip">
                  Looks good!
                </div>
              </div>
